...
{
    public partial class ManagementOfLearningForm : Form
    {
        public ManagementOfLearningForm()
        {
            InitializeComponent();
        }

        private void ManagementOfLearningForm_Load(object sender, EventArgs e)
        {
            ConnectAPI.dgvViewing("Management", dgvManagement);

            AddRadioButtonsToDataGridView();
            dgvManagement.Columns[0].Width = 850;
        }
        private void AddRadioButtonsToDataGridView()
        {
            for (int i = 1; i <= 5; i++)
            {
                ...
                dgvManagement.Columns.Add(radioButtonColumn);
            }
        }
        ...
        {
            EvaluationReport form = new EvaluationReport();
            form.Show();
            this.Hide();
        }
    }
