...
{
    public partial class TeachingTableForm : Form
    {
        public TeachingTableForm()
        {
            InitializeComponent();
        }

        private void TeachingTableForm_Load(object sender, EventArgs e)
        {
            ConnectAPI.dgvViewing("Teaching", dgvTeaching);

            AddRadioButtonsToDataGridView();
            dgvTeaching.Columns[0].Width = 840;
        }
        private void AddRadioButtonsToDataGridView()
        {
            for (int i = 1; i <= 5; i++)
            {
                ...
                dgvTeaching.Columns.Add(radioButtonColumn);
            }
        }
        ...
        {
            ManagementOfLearningForm f = new ManagementOfLearningForm();
            f.Show();
            this.Hide();
        }
        ...
        private void btnResult_Click(object sender, EventArgs e)
        {
            ...
            foreach (DataGridViewRow row in dgvTeaching.Rows)
            {
